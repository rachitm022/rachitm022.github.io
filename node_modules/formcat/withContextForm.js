  ...
  function (_Component) {
    ...
    (0, _createClass2.default)(Field, [{
      ...
      value: function render() {
        ...
        var value = (0, _lodash.default)(context.fields[props.name], 'value', '');
        var checked = (0, _lodash.default)(context.fields[props.name], 'checked', false);
        var error = (0, _lodash.default)(context.fields[props.name], 'error', false);
